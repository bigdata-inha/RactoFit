...
def check_args(args):
    ...
    if args.context == 'Generation':
        if args.method == 'Hardsample_Replay' or args.method == 'DGZ' or args.method == 'RehearsalDGZ' or args.method == 'LactoDGZ' or args.method == 'Lactogan':
            args.result_dir = os.path.join(args.result_dir, args.context, args.task_type, args.dataset, args.method,
                                           args.gan_type,
                                           'hardsample_epoch' + str(args.hardsample_epoch),
                                           'seed_' + str(args.seed))
            args.save_dir = os.path.join(args.save_dir, args.context, args.task_type, args.dataset, args.method,
                                         args.gan_type,
                                         'hardsample_epoch' + str(args.hardsample_epoch), 'seed_' + str(args.seed))
    ...
    if args.gan_type == "CVAE" or args.gan_type == "CGAN" or args.gan_type == 'CWGAN_GP':
...
def load_datasets(args):
    #print('load_dataset: ', args.data_file)
    ...
    #print('load_dataset: ', os.path.join(args.data_dir, 'Tasks', args.dataset, train_file))
    # Archives/Data/Tasks/mnist/...
